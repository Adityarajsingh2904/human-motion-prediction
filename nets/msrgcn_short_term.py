...
class MSRGCNShortTerm(nn.Module):
    def __init__(self, p_dropout, leaky_c=0.2, final_out_noden=22, input_feature=35):
        ...
        self.fourth_left = nn.Sequential(
            GC_Block(
                in_features=256, p_dropout=p_dropout, node_n=12, leaky_c=leaky_c
            ),  # 64, 0.5, 66
        ...
        self.first_out = PostGCN(
            input_feature=256, hidden_feature=input_feature, node_n=final_out_noden * 3
        )
        ...
        self.second_out = PostGCN(
            input_feature=256, hidden_feature=input_feature, node_n=36
        )
        ...
        self.fourth_out = PostGCN(
            input_feature=256, hidden_feature=input_feature, node_n=12
        )
